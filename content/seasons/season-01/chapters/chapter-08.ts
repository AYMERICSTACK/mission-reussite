...
export const chapter08: NarrativeChapter = {
  id: "season-01-chapter-08",
  slug: "les-ruines-du-hibou",
  number: 8,
  title: "Les Ruines du Hibou",
  subtitle: "Sous les pierres repose la mémoire des premiers gardiens.",
  summary: "Une fresque raconte la naissance de la Porte des Mondes, mais plusieurs morceaux ont disparu. Il faut reconstruire le récit avant la tombée de la nuit.",
  location: "Les Ruines d’Orion",
  symbol: "🏛️",
  tracks: ["alyssio"],
  opening: [
    { speaker: "Narrateur", text: "Le signal de la boussole entraîne l’équipe vers Les Ruines d’Orion." },
  ...
  missions: [
    {
      id: "chapter-08-mission-01",
      title: "Le message caché",
      activitySlug: "grande-bibliotheque-alyssio-039",
    ...
    {
      id: "chapter-08-mission-02",
      title: "Les nombres du sentier",
      activitySlug: "grande-bibliotheque-alyssio-040",
    ...
    {
      id: "chapter-08-mission-03",
      title: "La phrase des gardiens",
      activitySlug: "grande-bibliotheque-alyssio-041",
    ...
    {
      id: "chapter-08-mission-04",
      title: "Le calcul des cristaux",
      activitySlug: "grande-bibliotheque-alyssio-042",
      objective: "Résoudre le défi sans se précipiter.",
      intro: [{ speaker: "Nova", text: "Une étape à la fois. Chaque réussite stabilise le chemin." }],
      outro: [{ speaker: "Oscar", text: "Indice validé. Le chemin devient plus clair.", mood: "happy" }],
    },
    {
      id: "chapter-08-mission-05",
      title: "L’indice oublié",
      activitySlug: "grande-bibliotheque-alyssio-043",
      objective: "Relier plusieurs indices pour comprendre la situation.",
      intro: [{ speaker: "Oscar", text: "Une étape à la fois. Chaque réussite stabilise le chemin." }],
      outro: [{ speaker: "Nova", text: "Indice validé. Le chemin devient plus clair.", mood: "happy" }],
    },
    {
      id: "chapter-08-mission-06",
      title: "La clé du passage",
      activitySlug: "grande-bibliotheque-alyssio-044",
  ...
  reward: { id: "reward-chapter-08", label: "Fragment de Fresque", description: "Une pièce de l’histoire oubliée des gardiens.", symbol: "🏛️", xpBonus: 60 },
};
